...
db_pathway_table = "tran_upkeep.load_pathway"

# sql statements
sql_insert = """insert into {} (pathway_code, pathway_name, pathway_updated_name)
         values (%s, %s, %s) 
...
if __name__ == "__main__":
    ...
    for row in list_pathways:
        # insert
        cur.execute(sql_insert, (row['id'], row['name'], row['new_name']))
        counter = counter + 1
