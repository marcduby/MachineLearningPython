...
def build_molepro_result_list(result, original_curie, curie_name):
  ''' will build a list of results '''
  # initialize
  result_list = []
  # print(result['message']['knowledge_graph'])
...
list_predicates_gene_chem = ['biolink:affected_by']
noonan_list_gene = ['NCBIGene:673', 'NCBIGene:5781', 'NCBIGene:5604', 'NCBIGene:6774']
list_predicates_disease = ['biolink:affected_by']

cacna1d_list_gene = ['HGNC:1391']

slc2a1_list_gene = ['HGNC:11005', 'HGNC:6884']

breakout01_list_gene = ['HGNC:18756', 'HGNC:3151']
breakout03_list_gene = ['HGNC:6284', 'HGNC:9153']
breakout03_taybi_list_gene = ['HGNC:3373', 'HGNC:2348']


list_gene = breakout03_taybi_list_gene
...
for input_curie in list_gene:
  ...
  for curie in list_synonym:
    for pred in list_predicates_gene_chem:
      ...
      input_json['message']['query_graph']['nodes']['n00']['categories'] = ['biolink:Gene']
      input_json['message']['query_graph']['nodes']['n01']['categories'] = ['biolink:ChemicalSubstance']
      input_json['message']['query_graph']['edges']['e00']['predicates'] = [pred]
      ...
      # get the list for the response
      temp_result_list = build_molepro_result_list(response.json(), input_curie, curie_name)
