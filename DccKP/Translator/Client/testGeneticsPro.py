...
list_number_test = [10, 20, 30, 40, 50]
list_number_test = [2, 4, 6, 8, 10]
list_number_test = [10, 50, 100, 200, 500, 1000, 2000, 3000, 5000, 10000]
...
if __name__ == "__main__":
    ...
    # test the service
    for count in list_number_test:
        list_curie_input = list_disease_inputs[:count]
